...
private:
  ...
  /*
   * \brief Gives a rough estimation of transport block size in bytes that would be enough to transmit data from all logical channels of this UE .
   * First checks which logical channel has most data for transmission and then it multiplies this value with number of logical channels.
   * It is multiplied by the number of the logical channels, because currently proportional scheduler divides equally resources among logical channels.
   *
