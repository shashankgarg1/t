...
private:
  ...
  uint32_t m_earfcn;     ///< The `Earfcn` attribute.
  ...
  double m_noiseFigureDb;  ///< The `NoiseFigureDb` attribute.
  ...
  double m_noisePowerW; ///< The noise power value used internally for the SINR calculations
