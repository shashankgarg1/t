...
{
public:
  LteSpectrumModelTestCase (const char* str, uint32_t earfcn, uint8_t bw, std::vector<double> fcs);
...
LteSpectrumModelTestCase::LteSpectrumModelTestCase (const char* str, uint32_t earfcn, uint8_t bw, std::vector<double> fcs)
...
{
public:
  LteNoisePsdTestCase (const char* str, uint32_t earfcn, uint8_t bw, double noiseFigureDb, SpectrumValue& expected);
...
LteNoisePsdTestCase::LteNoisePsdTestCase (const char* str, uint32_t earfcn, uint8_t bw, double noiseFigureDb, SpectrumValue& expected)
  :   TestCase (str),
...
{
public:
  LteTxPsdTestCase (const char* str, uint32_t earfcn, uint8_t bw, double txPowerDbm, std::vector<int> activeRbs, SpectrumValue& expected);
...
LteTxPsdTestCase::LteTxPsdTestCase (const char* str, uint32_t earfcn, uint8_t bw, double txPowerDbm, std::vector<int> activeRbs, SpectrumValue& expected)
  :   TestCase (str),
