...
public:
  ...
  /** 
   * 
   * \return the SpectrumPropagationLossModel instance eventually used by this channel
   */
   ...
   * 
   * 
   * \return the PropagationLossModel instance eventually used by this channel
   */
