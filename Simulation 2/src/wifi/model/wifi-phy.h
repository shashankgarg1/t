...
public:
  ...
  /**
   * The channel model to use for PHY error rates
   */
  enum ChannelModel
  {
    /**
    ...
    AWGN,
    /**
     * IEEE TGn frequency selective channel model D (with AWGN)
     */
    D,
    /**
     * User-defined model; user must add own error rate datapoints
     */
    USER_DEFINED
  };
  ...
  */
   ...
   */
  virtual std::vector<uint32_t> GetOperationalChannelList (void) const = 0;
