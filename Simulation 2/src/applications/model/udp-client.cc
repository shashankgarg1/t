...
UdpClient::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::UdpClient")
    ...
    .AddAttribute ("TypeOfService", "Socket IP_TOS value to use",
                   UintegerValue (0),
                   MakeUintegerAccessor (&UdpClient::SetTypeOfService,
                                         &UdpClient::GetTypeOfService),
...
void
UdpClient::SetTypeOfService (uint8_t tos)
{
...
uint8_t
UdpClient::GetTypeOfService (void) const
{
  NS_LOG_FUNCTION (this);
