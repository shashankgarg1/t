...
\GNUPLOTpicture(7200,5040)
  \special{psfile=images/pstex/indoor_-72_0_ftpLambda_0_5_Laa_voice_latency.ps llx=0 lly=0 urx=360 ury=252 rwi=3600}
  \put(5936,803){\rjust{\strut{}operator B (Wi-Fi)}}%
  \put(3849,140){\cjust{\strut{}Voice Latency [ms]}}%
  \put(160,2719){%
