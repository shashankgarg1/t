...
def register_types(module):
    ...
    module.add_class('LogNormalShadowingIid', import_from_module='ns.propagation')
    ...
    ## position-allocator.h (module 'mobility'): ns3::UniformHexagonPositionAllocator [class]
    module.add_class('UniformHexagonPositionAllocator', import_from_module='ns.mobility', parent=root_module['ns3::PositionAllocator'])
...
def register_methods(root_module):
    ...
    register_Ns3UniformHexagonPositionAllocator_methods(root_module, root_module['ns3::UniformHexagonPositionAllocator'])
...
def register_Ns3UniformHexagonPositionAllocator_methods(root_module, cls):
    ## position-allocator.h (module 'mobility'): ns3::UniformHexagonPositionAllocator::UniformHexagonPositionAllocator(ns3::UniformHexagonPositionAllocator const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::UniformHexagonPositionAllocator const &', 'arg0')])
    ## position-allocator.h (module 'mobility'): ns3::UniformHexagonPositionAllocator::UniformHexagonPositionAllocator() [constructor]
    cls.add_constructor([])
    ## position-allocator.h (module 'mobility'): int64_t ns3::UniformHexagonPositionAllocator::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')], 
                   is_virtual=True)
    ## position-allocator.h (module 'mobility'): ns3::Vector ns3::UniformHexagonPositionAllocator::GetNext() const [member function]
    cls.add_method('GetNext', 
                   'ns3::Vector', 
                   [], 
                   is_const=True, is_virtual=True)
    ## position-allocator.h (module 'mobility'): static ns3::TypeId ns3::UniformHexagonPositionAllocator::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## position-allocator.h (module 'mobility'): void ns3::UniformHexagonPositionAllocator::PrintToGnuplotFile(std::string filename) [member function]
    cls.add_method('PrintToGnuplotFile', 
                   'void', 
...
def register_Ns3BuildingsPropagationLossModel_methods(root_module, cls):
    ...
    cls.add_method('InternalWallsLoss', 
                   ...
                   is_const=True, visibility='protected')
    ## buildings-propagation-loss-model.h (module 'buildings'): double ns3::BuildingsPropagationLossModel::EvaluateSigma(ns3::Ptr<ns3::MobilityModel> a, ns3::Ptr<ns3::MobilityModel> b) const [member function]
