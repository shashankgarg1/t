...
public:
   ...
   *
   * RFC 1349 specifies the following encoding of TOS in IPv4 headers:
   *
   *             0     1     2     3     4     5     6     7
   *          +-----+-----+-----+-----+-----+-----+-----+-----+
   *          |   PRECEDENCE    |          TOS          | MBZ |
   *          +-----+-----+-----+-----+-----+-----+-----+-----+
   *
   * The combination of precedence and Tos bits will be converted into
   * an IPv4 or IPv6 DSCP value encoded in the IP header.  The following
   * conversion applies:
   *   DSCP decimal  DSCP class  TOS value decimal
   *       0            CS0 (none)       0
   *       8            CS1             32
   *       10           AF11            40
   *       12           AF12            48
   ...
   *       56           CS7            224
   *
   * So to use this method, pass a TOS value from the above table as the
   * parameter to this method; other values passed are undefined.
   * 
