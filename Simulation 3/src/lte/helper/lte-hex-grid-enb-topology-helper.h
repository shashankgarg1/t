...
public:
   ...
   * 
   * \return the position of the antenna site to which the cell belongs
   */
   ...
   * \param cellIndex index of the cell within the hexagonal topology
   * 
   * \return the position of the antenna of the cell (typically this
   ...
   * \param cellIndex index of the cell within the hexagonal topology
   * 
   * \return the antenna orientation on the x-y plane, in degrees
   */
   ...
   * \param cellIndex index of the cell within the hexagonal topology
   * 
   * \return the position of the center of the hexagonal cell 
   */
  Vector GetCellCenterPosition (uint32_t cellIndex);

  /** 
   * 
   * \return the radius of the cells in the hexagonal topology
   */
