...
def register_Ns3BulkSendApplication_methods(root_module, cls):
    ...
    cls.add_method('GetSocket', 
                   ...
                   [], 
                   is_const=True)
    ## bulk-send-application.h (module 'applications'): uint32_t ns3::BulkSendApplication::GetTotalBytes() const [member function]
...
def register_Ns3OnOffApplication_methods(root_module, cls):
    ...
    cls.add_method('GetSocket', 
                   ...
                   [], 
                   is_const=True)
    ## onoff-application.h (module 'applications'): uint32_t ns3::OnOffApplication::GetTotalBytes() const [member function]
    cls.add_method('GetTotalBytes', 
                   'uint32_t', 
                   [], 
                   is_const=True)
...
def register_Ns3UdpClient_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## udp-client.h (module 'applications'): uint32_t ns3::UdpClient::GetSent() const [member function]
    cls.add_method('GetSent', 
                   'uint32_t', 
                   [], 
                   is_const=True)
