...
def register_types(module):
    ...
    ## wifi-phy.h (module 'wifi'): ns3::WifiPhy::ChannelModel [enumeration]
    module.add_enum('ChannelModel', ['AWGN', 'D', 'USER_DEFINED'], outer_class=root_module['ns3::WifiPhy'], import_from_module='ns.wifi')
...
def register_Ns3WifiMode_methods(root_module, cls):
    ...
    cls.add_method('GetModulationClass', 
                   ...
                   [], 
                   is_const=True)
    ## wifi-mode.h (module 'wifi'): uint8_t ns3::WifiMode::GetNumSpatialStreams() const [member function]
    cls.add_method('GetNumSpatialStreams', 
                   'uint8_t', 
                   [], 
                   is_const=True)
...
def register_Ns3WifiModeFactory_methods(root_module, cls):
    ...
    ## wifi-mode.h (module 'wifi'): static ns3::WifiMode ns3::WifiModeFactory::CreateWifiMode(std::string uniqueName, ns3::WifiModulationClass modClass, bool isMandatory, uint32_t bandwidth, uint32_t dataRate, ns3::WifiCodeRate codingRate, uint8_t constellationSize, uint8_t numSpatialStreams) [member function]
    cls.add_method('CreateWifiMode', 
                   'ns3::WifiMode', 
                   [param('std::string', 'uniqueName'), param('ns3::WifiModulationClass', 'modClass'), param('bool', 'isMandatory'), param('uint32_t', 'bandwidth'), param('uint32_t', 'dataRate'), param('ns3::WifiCodeRate', 'codingRate'), param('uint8_t', 'constellationSize'), param('uint8_t', 'numSpatialStreams')], 
                   is_static=True)
    return
...
def register_Ns3WifiPhy_methods(root_module, cls):
    ...
    cls.add_method('ConfigureStandard', 
                   ...
                   [param('ns3::WifiPhyStandard', 'standard')], 
                   is_pure_virtual=True, is_virtual=True)
    ## wifi-phy.h (module 'wifi'): static double ns3::WifiPhy::DbToRatio(double db) [member function]
    cls.add_method('DbToRatio', 
                   'double', 
                   [param('double', 'db')], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static double ns3::WifiPhy::DbmToW(double dbm) [member function]
    ...
    cls.add_method('GetNumberOfTransmitAntennas', 
                   ...
                   [], 
                   is_pure_virtual=True, is_const=True, is_virtual=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate104MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate104MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate108MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate108MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate108MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate115_6MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate115_6MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate117MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate117MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate120MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate120MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate120MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate12MbpsBW5MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate130MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate130MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate130_3MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate130_3MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate13MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate13MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate13MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate13_5MbpsBW5MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate144_4MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate144_4MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate14_4MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate14_4MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate14_4MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate15MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate162MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate162MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate180MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate180MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate1_5MbpsBW5MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate216MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate216MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate21_7MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate240MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate240MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate243MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate243MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate26MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate26MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate26MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate270MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate270MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate270MbpsBW40MHzShGi2SS() [member function]
    cls.add_method('GetOfdmRate270MbpsBW40MHzShGi2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate27MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate27MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate27MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate28_9MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate28_9MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate28_9MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate2_25MbpsBW5MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate300MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate300MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate30MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate30MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate30MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate39MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate39MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate39MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate43_3MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate43_3MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate43_3MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate52MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate52MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate52MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate54MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate54MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate54MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate57_8MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate57_8MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate57_8MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate60MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate60MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate60MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate72_2MbpsBW20MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate78MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate78MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate81MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate81MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate81MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate86_7MbpsBW20MHz2SS() [member function]
    cls.add_method('GetOfdmRate86_7MbpsBW20MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate90MbpsBW40MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::WifiMode ns3::WifiPhy::GetOfdmRate90MbpsBW40MHz2SS() [member function]
    cls.add_method('GetOfdmRate90MbpsBW40MHz2SS', 
                   'ns3::WifiMode', 
                   [], 
                   is_static=True)
    ...
    cls.add_method('GetOfdmRate9MbpsBW5MHz', 
                   ...
                   [], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): std::vector<unsigned int, std::allocator<unsigned int> > ns3::WifiPhy::GetOperationalChannelList() const [member function]
    ...
    cls.add_method('GetPlcpPreambleDuration', 
                   ...
                   [param('ns3::WifiMode', 'payloadMode'), param('ns3::WifiPreamble', 'preamble')], 
                   is_static=True)
    ## wifi-phy.h (module 'wifi'): static ns3::Time ns3::WifiPhy::GetPlcpSyncFieldDuration(ns3::WifiMode payloadMode, ns3::WifiPreamble preamble) [member function]
    cls.add_method('GetPlcpSyncFieldDuration', 
                   'ns3::Time', 
                   [param('ns3::WifiMode', 'payloadMode'), param('ns3::WifiPreamble', 'preamble')], 
                   is_static=True)
    ...
    cls.add_method('IsStateTx', 
                   ...
                   [], 
                   is_pure_virtual=True, is_virtual=True)
    ## wifi-phy.h (module 'wifi'): ns3::WifiMode ns3::WifiPhy::McsToWifiMode(uint8_t mcs, uint8_t numSpatialStreams) [member function]
    cls.add_method('McsToWifiMode', 
                   'ns3::WifiMode', 
                   [param('uint8_t', 'mcs'), param('uint8_t', 'numSpatialStreams')], 
                   is_pure_virtual=True, is_virtual=True)
    ...
    cls.add_method('NotifyTxEnd', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'packet')])
    ## wifi-phy.h (module 'wifi'): static double ns3::WifiPhy::RatioToDb(double ratio) [member function]
    ...
    cls.add_method('UnregisterListener', 
                   ...
                   [param('ns3::WifiPhyListener *', 'listener')], 
                   is_pure_virtual=True, is_virtual=True)
    ## wifi-phy.h (module 'wifi'): static double ns3::WifiPhy::WToDbm(double w) [member function]
