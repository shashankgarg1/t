  ...
  : TestSuite ("lte-earfcn", UNIT)
{
  ...
  AddTestCase (new LteEarfcnDlTestCase ("DL EARFCN=255444", 255444, 5180e6), TestCase::QUICK);
  AddTestCase (new LteEarfcnDlTestCase ("DL EARFCN=261694", 261694, 5805e6), TestCase::QUICK);
